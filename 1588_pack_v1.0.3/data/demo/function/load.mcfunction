...
tellraw @p ["",{"text":"使用說明:","bold":true,"color":"dark_aqua"},{"translate":"點我開啟說明","bold":true,"underlined":true,"color":"dark_blue","clickEvent":{"action":"open_url","value":"https://reurl.cc/g60qbV"},"hoverEvent":{"action":"show_text","contents":[{"text":"https://docs.google.com/document/d/1F0iU0a1WtNnI2x_AQKOwnFof0hFdL3EYWAR4OK3tuWc/edit","italic":true,"color":"gray"}]}}]
